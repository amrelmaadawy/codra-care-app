...
class DoctorQueueAppBar extends StatelessWidget implements PreferredSizeWidget {
  final int totalActive;
  final bool hasUrgent;

  const DoctorQueueAppBar({
    super.key,
          ...
          if (totalActive > 0)
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: hasUrgent
                      ? AppColors.statusUrgent.withValues(alpha: 0.4)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 6,
                    decoration: BoxDecoration(
                      color: hasUrgent ? AppColors.statusUrgent : context.primaryColor,
